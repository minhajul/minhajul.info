            ...
            <div class="grid grid-cols-1 gap-4 items-start lg:grid-cols-3 lg:gap-8">
                <div class="grid grid-cols-1 lg:col-span-3">
                    ...
                    <div class="mt-2 grid grid-cols-1 gap-5">
                        <form action="{{ route('admin.people.edit', $people) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="px-4 py-5 bg-white sm:p-6 shadow rounded-md">
                                <div class="grid grid-cols-6 gap-6">
                                    ...
                                    <div class="col-span-6">
                                        ...
                                        <input type="text" name="name" value="{{ old('name', $people->name) }}" class="mt-2 shadow-sm appearance-none border border-gray-200 rounded w-full py-2 px-3 text-sm text-gray-700 leading-tight focus:outline-none">
                                    ...
                                    <div class="col-span-6">
                                        ...
                                        <input type="text" name="designation" value="{{ old('designation', $people->designation) }}" class="mt-2 shadow-sm appearance-none border border-gray-200 rounded w-full py-2 px-3 text-sm text-gray-700 leading-tight focus:outline-none">
                                    ...
                                    <div class="col-span-6">
                                        ...
                                        <select name="role" class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:outline-none focus:ring-gray-300 focus:border-gray-300 sm:text-sm rounded-md">
                                            ...
                                            @foreach(config('enums.people_roles') as $role)
                                                <option {{ $people->role == $role ? 'selected' : '' }} value="{{ old('role', $people->role) }}">{{ $role }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-span-6">
                                        ...
                                        <input id="x" type="hidden" name="career_summary" value="{{ old('career_summary', $people->career_summary) }}">
