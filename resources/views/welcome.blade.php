...
<head>
    ...
    <meta name="twitter:image" content="{{ asset('images/minhajul.jpeg') }}">

    <meta name="og:site_name" content="A full-stack developer at Teleaus">
    <meta name="og:image" content="{{ asset('images/minhajul.jpeg') }}">
        ...
        <svg class="absolute top-0 left-1/2 transform translate-x-64 -translate-y-8" width="640" height="784" fill="none" viewBox="0 0 640 784">
            <defs>
                <pattern id="9ebea6f4-a1f5-4d96-8c4e-4c2abf658047" x="118" y="0" width="20" height="20" patternUnits="userSpaceOnUse">
                    <rect x="0" y="0" width="4" height="4" class="text-gray-50" fill="currentColor"></rect>
                </pattern>
            </defs>
        ...
        <main class="mt-16 mx-auto max-w-7xl px-4 sm:mt-24 sm:px-6 lg:mt-32">
            <div class="lg:grid lg:grid-cols-12 lg:gap-8">
                <div class="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left">
                    <h1>
                        <span class="block text-sm font-normal tracking-wide text-gray-50 sm:text-base lg:text-sm xl:text-base">
                            Hi
                        </span>
                        <span class="mt-1 block tracking-tight sm:text-5xl xl:text-6xl">
                            <span class="block font-extrabold text-gray-50">I'm Minhajul Islam</span>
                            <span class="block text-normal font-bold text-gray-50 text-3xl mt-3">
                    ...
                    <p class="mt-6 text-gray-50">
                        You can also find me on <a target="_blank" class="text-blue-400 font-bold" href="https://twitter.com/minhaj_cse">Twitter</a> and
                        <a target="_blank" class="text-blue-400 font-bold" href="https://github.com/minhajul">Github</a>.
                    </p>
                </div>
                <div class="mt-12 relative sm:max-w-lg sm:mx-auto lg:mt-0 lg:max-w-none lg:mx-0 lg:col-span-6 lg:flex lg:items-center">
                    ...
                    <div class="relative mx-auto w-full rounded-lg shadow-lg lg:max-w-md">
                        <div class="relative block w-full bg-white rounded-lg overflow-hidden focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                            <img class="w-full" src="{{ asset('images/minhajul.jpeg') }}" alt="Minhajul Islam">
                        </div>
                    </div>
                </div>
            </div>
