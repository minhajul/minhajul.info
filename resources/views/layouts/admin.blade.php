...
<head>
    ...
    <title>{{ config('app.name') }} - A better way to manage your money</title>
    ...
    <div class="h-screen flex overflow-hidden bg-gray-100" x-data="{ sidebarOpen: false }" @keydown.window.escape="sidebarOpen = false">
                ...
                <transition enter-active-class="transition ease-in-out duration-300 transform" enter-class="-translate-x-full" enter-to-class="translate-x-0" leave-active-class="transition ease-in-out duration-300 transform" leave-class="translate-x-0" leave-to-class="-translate-x-full"><div x-show="sidebarOpen" x-description="Off-canvas menu, show/hide based on off-canvas menu state." class="relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-gray-900">
                        ...
                        <nav class="mt-5 flex-shrink-0 h-full divide-y overflow-y-auto" aria-label="Sidebar">
                            <div class="px-2 space-y-1">
                                ...
                                <a href="{{ route('admin.home') }}" class="text-white hover:text-black hover:bg-white group flex items-center px-2 py-2 text-base font-medium rounded-md" aria-current="page">
                            ...
                            <div class="mt-6 pt-6">
                                <div class="px-2 space-y-1">
                                    ...
                                    <a href="{{ route('admin.settings.index') }}" class="text-white hover:text-black hover:bg-white  group flex items-center px-2 py-2 text-base font-medium rounded-md">
                ...
                <div class="flex flex-col flex-grow bg-gray-900 pt-5 pb-4 overflow-y-auto">
                    ...
                    <nav class="mt-5 flex-1 flex flex-col divide-y divide-cyan-800 overflow-y-auto" aria-label="Sidebar">
                        <div class="px-2 space-y-1">
                            ...
                            <a href="{{ route('admin.home') }}" class="text-white hover:text-black hover:bg-white group flex items-center px-2 py-2 text-sm leading-6 font-medium rounded-md" aria-current="page">
                                <svg class="mr-4 h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path>
                                </svg>
                                Home
                        ...
                        <div class="mt-6 pt-6">
                            <div class="px-2 space-y-1">
                                ...
                                <a href="{{ route('admin.settings.index') }}" class="text-white hover:text-black hover:bg-white  group flex items-center px-2 py-2 text-sm leading-6 font-medium rounded-md">
                                    <svg class="mr-4 h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z"></path>
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
                                    </svg>
        ...
        <div x-init="$el.focus()" class="flex-1 overflow-auto focus:outline-none" tabindex="0">
            <div class="relative z-10 flex-shrink-0 flex h-16 bg-white border-b border-gray-200 lg:border-none">
                ...
                <!-- Search bar -->
                <div class="flex-1 px-4 flex justify-between lg:max-w-6xl lg:mx-auto">
