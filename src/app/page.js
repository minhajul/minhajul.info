              ...
              <main className="mt-16 mx-auto max-w-7xl px-4 sm:mt-24 sm:px-6 lg:mt-32">
                <div className="lg:grid lg:grid-cols-12 lg:gap-8">
                  <div className="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left">
                    <h2>
                                        <span
                                            className="block text-sm font-normal tracking-wide text-gray-500 sm:text-base lg:text-sm xl:text-base">
                                            {"Hi"}
                                        </span>
                      <span className="mt-1 block tracking-tight">
                                            <span
                                                className="block mb-5 text-5xl animate-move-bg bg-gradient-to-r from-indigo-500 via-pink-500 to-indigo-500 bg-[length:400%] bg-clip-text font-extrabold text-transparent">
                                                {"I'm Minhajul Islam"}
                                            </span>
                                            <span className="block text-normal font-bold text-black text-3xl mt-3">
                                                {"Software & Application Lead at"} <a target="_blank" rel="noreferrer"
                                                                                      className="text-blue-400 font-extrabold"
                                                                                      href="https://genofax.com">Genofax</a>
                                            </span>
                                        </span>
                    </h2>
                    ...
                    <p className="mt-6 text-gray-500">
                      ...
                      <a target="_blank" rel="noreferrer" className="text-black font-bold ml-1"
                         href="https://twitter.com/minhaj_cse">Twitter</a>,
                      <a target="_blank" rel="noreferrer" className="text-black font-bold"
                         href="https://www.linkedin.com/in/minhajul52/"> LinkedIn</a> and
                      <a target="_blank" rel="noreferrer" className="text-black font-bold"
                         href="https://github.com/minhajul"> Github</a>.
                    </p>
                  </div>
