...
import profilePic from '../public/minhajul.jpeg'
                            ...
                            <div className="lg:grid lg:grid-cols-12 lg:gap-8">
                                <div className="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left">
                                    <h2>
                                        ...
                                        <span className="mt-1 block tracking-tight">
                                            ...
                                            <span className="block text-normal font-bold text-black text-3xl mt-3">
                                                {"Engineering Lead at"} <a target="_blank" rel="noreferrer" className="text-blue-400 font-extrabold" href="https://teleaus.com">TELEAUS</a>
                                            </span>
                                        </span>
                                    </h2>
                                    ...
                                    <p className="mt-6 text-gray-500">
                                        ...
                                        <a target="_blank" rel="noreferrer" className="ml-1 text-black font-bold" href="https://twitter.com/minhaj_cse">Twitter</a>,
